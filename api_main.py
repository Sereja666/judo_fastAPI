...
from database.middleware import LocalSupersetAuthMiddleware, LocalHttpsSupersetAuthMiddleware
...
app.add_middleware(LocalHttpsSupersetAuthMiddleware, superset_base_url=SUPERSET_BASE_URL)
